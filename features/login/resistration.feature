...
Scenario Outline: User Registration Successfully
  ...
  Examples:
  	|user						  |msg1											                      |msg2		  |
  	|role=Runner     	|Please check your email for verification link	|Welcome	|
    |role=Coach       |Please check your email for verification link  |Welcome  |
    |role=Company Admin		    |Please check your email for verification link	|Register Care Home	|
